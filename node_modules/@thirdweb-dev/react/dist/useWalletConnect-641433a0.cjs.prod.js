...
var formElements = require('./formElements-f5f93ffa.cjs.prod.js');
var Tooltip = require('./Tooltip-fb2aa96c.cjs.prod.js');
...
var coinbaseWallet = require('./safeChainSlug-c475f384.cjs.prod.js');
...
const ConnectedWalletDetails = props => {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      y: "lg"
    }), /*#__PURE__*/jsxRuntime.jsx(ConnectedToSmartWallet, {}), /*#__PURE__*/jsxRuntime.jsx(EmbeddedWalletEmail, {}), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      style: {
        display: "grid",
...
const DropdownLabel = /* @__PURE__ */formElements.StyledLabel(() => {
  const theme = formElements.useCustomTheme();
  return {
    fontSize: formElements.fontSize.sm,
    color: theme.colors.secondaryText,
...
const DisconnectIconButton = /* @__PURE__ */styled__default["default"](formElements.IconButton)(() => {
  const theme = formElements.useCustomTheme();
  return {
    marginRight: `-${formElements.spacing.xxs}`,
    marginLeft: "auto",
    color: theme.colors.secondaryText,
    "&:hover": {
      color: theme.colors.danger,
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-c475f384.cjs.prod.js'); }).then(function (n) { return n.RainbowWallet; });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-c475f384.cjs.prod.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-c475f384.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-c475f384.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-7e8a79aa.cjs.prod.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-0e285b05.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-b2451f8b.cjs.prod.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-c475f384.cjs.prod.js'); }).then(function (n) { return n.walletConnect$1; });
