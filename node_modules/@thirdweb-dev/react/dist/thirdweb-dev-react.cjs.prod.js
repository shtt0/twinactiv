...
var useWalletConnect = require('./useWalletConnect-641433a0.cjs.prod.js');
...
var frameWallet = require('./frameWallet-7e8a79aa.cjs.prod.js');
var wallets = require('@thirdweb-dev/wallets');
var formElements = require('./formElements-f5f93ffa.cjs.prod.js');
var reactIcons = require('@radix-ui/react-icons');
var styled = require('@emotion/styled');
var jsxRuntime = require('react/jsx-runtime');
var magicLink = require('./magicLink-bcf6b365.cjs.prod.js');
var paperWallet = require('./paperWallet-0e285b05.cjs.prod.js');
var safeWallet = require('./safeWallet-8471a47f.cjs.prod.js');
var walletConnectV1 = require('./walletConnectV1-b2451f8b.cjs.prod.js');
var useSafe = require('./useSafe-c2e5f7e4.cjs.prod.js');
var useMagic = require('./useMagic-ca7c706f.cjs.prod.js');
require('./Tooltip-fb2aa96c.cjs.prod.js');
...
const CryptoDefiWalletScan = _ref => {
  ...
  const locale = formElements.useTWLocale().wallets.cryptoDefiWallet;
  const createInstance = reactCore.useCreateWalletInstance();
  const [qrCodeUri, setQrCodeUri] = React.useState();
  const {
    setConnectedWallet,
...
const CryptoDefiWalletConnectUI = props => {
  ...
  if (screen === "scanning") {
    return /*#__PURE__*/jsxRuntime.jsx(CryptoDefiWalletScan, {
      onBack: props.goBack,
      onConnected: props.connected,
      onGetStarted: () => {
        setScreen("get-started");
...
const Coin98Scan = _ref => {
  ...
  const locale = formElements.useTWLocale().wallets.coin98Wallet;
  const createInstance = reactCore.useCreateWalletInstance();
  const [qrCodeUri, setQrCodeUri] = React.useState();
  const {
    setConnectedWallet,
...
const Coin98ConnectUI = props => {
  ...
  if (screen === "scanning") {
    return /*#__PURE__*/jsxRuntime.jsx(Coin98Scan, {
      onBack: props.goBack,
      onConnected: props.connected,
      onGetStarted: () => {
        setScreen("get-started");
...
exports.useEmbeddedWalletUserEmail = useWalletConnect.useEmbeddedWalletUserEmail;
