declare const _default: {
    ...
    readonly rpc: readonly ["https://zksync-era-testnet.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://280.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://testnet.era.zksync.dev"];
