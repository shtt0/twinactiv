 ...
 */
export declare class TokenBoundSmartWallet extends SmartWallet {
    ...
    static id: "tokenBoundSmartWallet";
    get walletName(): string;
    constructor(options: WalletOptions<TokenBoundSmartWalletConfig>);
    getConnector(): Promise<TokenBoundSmartWalletConnectorType>;
}
//# sourceMappingURL=token-bound-smart-wallet.d.ts.map