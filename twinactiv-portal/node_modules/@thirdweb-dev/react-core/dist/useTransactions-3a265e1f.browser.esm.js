...
function ThirdwebWalletProvider(props) {
  ...
  useEffect(() => {
    ...
    async function autoconnect() {
      ...
      let walletObj = props.supportedWallets.find(W => W.id === walletInfo.walletId);
      if (!walletObj) {
      ...
      if (personalWalletInfo) {
        ...
        if (walletObj.personalWallets) {
          ...
          walletObj = walletObj.personalWallets.find(w => w.id === walletInfo.walletId);
          if (!walletObj) {
            setConnectionStatus("disconnected");
            return;
          }
